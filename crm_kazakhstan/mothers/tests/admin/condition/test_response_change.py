...
class ResponseChangeMethodTest(TestCase):
    ...
    def test_redirect_finished_condition_with_datetime_and_another_condition(self):
        ...
        condition = Condition.objects.create(mother=mother, finished=True, scheduled_date='2024-01-09',
                                             scheduled_time='10:00:00')

        Condition.objects.create(mother=self.mother, finished=False, scheduled_date='2024-01-09',
                                 scheduled_time='10:00:00')
    ...
    def test_redirect_finished_false_and_scheduled_date(self):
        condition = Condition.objects.create(mother=self.mother, finished=False, scheduled_date='2024-01-09')
