...
class SaveModelMethodTest(TestCase):
    ...
    def test_add_first_condition_created(self):
        ...
        relative_path = reverse('admin:mothers_condition_add')
    ...
    def test_change_condition_scheduled_date_and_time_without_local_user_time(self):
        ...
        relative_path = reverse('admin:mothers_condition_change', args=[existing_condition.pk])
    ...
    def test_aa_condition_with_perms_change_and_view(self):
        mother = Mother.objects.create(name='Mother')
        obj = Condition(mother=mother, scheduled_date=date(2024, 1, 18))
        self.assertIsNone(obj.pk)
