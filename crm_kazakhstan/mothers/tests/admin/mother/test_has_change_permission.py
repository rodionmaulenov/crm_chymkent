...
class HasViewPermissionMethodTest(TestCase):
    ...
    def test_staff_has_change_perm_list_layer(self):
        mother = Mother.objects.create(name='Mother 1')
    ...
    def test_staff_has_change_perm_list_layer_with_model_lvl_view_perm(self):
    ...
    def test_staff_has_change_perm_on_obj_lvl(self):
        mother = Mother.objects.create(name='Mother 1')
        assign_perm('view_mother', self.staff_user, mother)
        assign_perm('change_mother', self.staff_user, mother)
    ...
    def test_staff_has_change_perm_list_layer_but_mother_instance_on_another_stage(self):
        mother = Mother.objects.create(name='Mother 1')
    ...
    def test_staff_has_not_change_perm_on_obj_lvl(self):
        mother = Mother.objects.create(name='Mother 1')
