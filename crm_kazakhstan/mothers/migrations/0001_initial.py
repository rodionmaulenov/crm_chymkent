# Generated by Django 3.2.23 on 2024-01-13 16:19
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('condition', models.CharField(choices=[('created', 'recently created'), ('no baby', 'has not baby'), ('WWW', 'wrote WhatsApp, waiting the answer')], default='created', max_length=10)),
