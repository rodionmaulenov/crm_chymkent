...
from documents.models import DocumentProxy, MainDocument
...
class AddMainDocsTest(TestCase):
    ...
    def test_add_document_link(self):
        ...
        required = (
            f'<a class="add-change-link " href="/admin/documents/documentproxy/{mother_pk}/change/?mother={mother_pk}&amp;documents=main">'
        )
    ...
    def test_if_user_has_only_view_perm(self):
        ...
        mother_pk = self.mother.pk
        required = (
            f'<a class="add-change-link disabled-link" href="/admin/documents/documentproxy/{mother_pk}/change/?mother={mother_pk}&amp;documents=main">'
        )
        self.assertIn(required, add_new)
