...
class AddRequireDocsTest(TestCase):
    ...
    def test_add_document_link(self):
        ...
        required = (
            f'<a class="add-change-link " href="/admin/documents/document/{mother_pk}/change/?mother={mother_pk}&amp;documents=required">'
        )
    ...
    def test_if_user_has_only_view_perm(self):
        ...
        mother_pk = self.mother.pk
        required = (
            f'<a class="add-change-link disabled-link" href="/admin/documents/document/{mother_pk}/change/?mother={mother_pk}&amp;documents=required">'
        )
        self.assertIn(required, add_new)
